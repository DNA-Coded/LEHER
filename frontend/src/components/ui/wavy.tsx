...
// Time speed factor (overall speed of animation - lowered for calm, cinematic ocean swells).
const TIME_FACTOR = 0.07;
// Swirl strength near the center.
const BASE_SWIRL_STRENGTH = 1.0;
// Finer swirl timing factor.
const SWIRL_TIME_MULT = 3.0;
...
void main() {
  ...
  angle += swirlStrength * sin(t * 1.5 + r * float(${SWIRL_TIME_MULT}));
...
export const WavyBackground = ({ 
  ...
  return (
    <div className={cn("relative w-full h-screen overflow-hidden", className)} style={style}>
      <canvas
        ref={canvasRef}
