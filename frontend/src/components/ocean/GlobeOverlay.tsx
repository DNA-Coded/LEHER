...
import { Waves, RotateCcw, ArrowLeft } from 'lucide-react';

interface GlobeOverlayProps {
  onBackToLanding?: () => void;
}

export const GlobeOverlay: React.FC<GlobeOverlayProps> = ({ onBackToLanding }) => {
  const {
    hoveredRegionId,
    selectedRegion,
    setSelectedRegion,
    ...
    <>
      ...
      <header
        style={{
          ...
          top: '20px',
          left: '28px',
          right: isPointDepthOpen ? 'calc(50vw + 20px)' : '28px',
          display: 'flex',
        ...
        >
          {onBackToLanding && (
            <button
              ...
              title="Return to Leher Homepage"
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: '6px',
